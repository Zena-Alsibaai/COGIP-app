...
<html lang="en">
    <head>
        ...
        <title>Delete Contact Page - COGIP</title>
    </head>
    ...
    <body>
        ...
        <header class="py-5 bg-dark">
            <div class="container">
                <h1 class="m-4 p-5 border border-5 border-warning rounded-pill text-center text-uppercase fw-bold bg-white display-4">Delete Companies Page</h1>
            </div>
        </header>
