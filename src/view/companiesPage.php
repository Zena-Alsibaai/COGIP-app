...
<body>
    <?php require 'includes/navbar.php' ?>
     ...
     <header class="py-5 bg-dark">
        ...
        <div class="container">
            <h1 class=" m-4 p-5 h5 border border-5 border-warning rounded-pill text-center text-uppercase fw-bold bg-white display-4 animation"> Companies Directory</h1>
            ...
            <tr >
                <?php 
                    foreach($resultsAll as  $resultsAll){
                        ...
                        <a href="companiesDetailsPage.php?id='.$companiesId.'" type="button" class="btn btn-outline-info">Details</a> </td>'. '</tr>';
                        }
